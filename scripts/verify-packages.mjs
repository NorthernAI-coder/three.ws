...
const PACKAGES = [
  ...
  { dir: 'mcp-server',                  name: '@3d-agent/mcp-server',     type: 'mcp',     bin: 'mcp-server',          minTools: 15 },
  ...
  { dir: 'packages/ibm-x402-mcp',       name: '@three-ws/ibm-x402-mcp',   type: 'mcp',     bin: 'ibm-x402-mcp',        minTools: 6 },
