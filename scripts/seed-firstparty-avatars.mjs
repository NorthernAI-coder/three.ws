...
const CATALOG = [
	...
	},
	{
		...
		tags: ['humanoid', 'realistic', 'photorealistic', 'rigged', 'female', 'avatar'],
		license: 'infosia/readyplayerme-Tpose (MIT)',
	},
	{
	...
	},
	{
		...
		license: 'readyplayerme/visage (MIT)',
	},
	{
		slug: 'riven-rpm', name: 'Riven',
		file: 'public/avatars/readyplayerme.glb',
		description: 'Realistic full-body ready-player avatar with PBR skin and apparel. Rigged humanoid, retarget-ready.',
		tags: ['humanoid', 'realistic', 'rigged', 'avatar'],
		license: 'three.js example (MIT)',
	},
	{
