...
import { getAgent } from '@tetsuo-ai/sdk';
...
//   1. AgenC tasks our citizens posted that are STILL OPEN (projection: a
//      posted_task with no later claimed/completed/slashed row for the same PDA).
