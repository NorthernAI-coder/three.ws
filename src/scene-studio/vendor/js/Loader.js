		...
		switch ( extension ) {
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					loader.setLibraryPath( `https://cdn.jsdelivr.net/npm/three@0.${THREE.REVISION}.0/examples/jsm/libs/rhino3dm/` );
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					loader.setPath( `https://cdn.jsdelivr.net/gh/mrdoob/three.js@r${THREE.REVISION}/examples/models/ldraw/officialLibrary/` );
