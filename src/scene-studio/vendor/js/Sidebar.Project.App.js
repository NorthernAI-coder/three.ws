...
function SidebarProjectApp( editor ) {
	...
	publishButton.onClick( function () {
		...
		loader.load( '/scene-studio/app/index.html', function ( content ) {
			...
			if ( config.getKey( 'project/editable' ) ) {
				...
				editButton = [
					...
					'			button.href = \'https://three.ws/scene#file=\' + location.href.split( \'/\' ).slice( 0, - 1 ).join( \'/\' ) + \'/app.json\';',
		...
		loader.load( '/scene-studio/app/app.js', function ( content ) {

			toZip[ 'js/app.js' ] = strToU8( content );

		} );
		loader.load( `https://cdn.jsdelivr.net/npm/three@0.${THREE.REVISION}.0/build/three.core.js`, function ( content ) {
		...
		if ( rendererType === 'WebGPURenderer' ) {
			...
			loader.load( `https://cdn.jsdelivr.net/npm/three@0.${THREE.REVISION}.0/build/three.webgpu.js`, function ( content ) {
			...
			loader.load( `https://cdn.jsdelivr.net/npm/three@0.${THREE.REVISION}.0/build/three.module.js`, function ( content ) {
