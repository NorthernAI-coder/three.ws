...
function Viewport( editor ) {
	...
	signals.rendererCreated.add( function ( newRenderer ) {
		...
		// Scene Studio is dark-locked: always use the dark viewport regardless
		// of the OS color scheme (upstream keys this off prefers-color-scheme).
		renderer.setClearColor( 0x1a1a1c );
