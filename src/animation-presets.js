...
export const CLIP_CATEGORIES = Object.freeze({
	// Idle & stand
	idle: 'idle', 'av-idle-breath': 'idle', 'av-waiting': 'idle', 'av-idle-anim': 'idle',
	'av-idle-male': 'idle', 'av-idle-female': 'idle', 'av-chilling': 'idle', 'av-pose1': 'idle',
	'av-leaning-wall': 'idle', 'av-smoking': 'idle', 'av-listening-music': 'idle', standup: 'idle',
	coverstand: 'idle',
	// Locomotion
	walk: 'locomotion', 'av-walk-feminine': 'locomotion', 'av-walk-crouching': 'locomotion',
	stepback: 'locomotion', dodge: 'locomotion',
	// Dance
	dance: 'dance', rumba: 'dance', silly: 'dance', thriller: 'dance', capoeira: 'dance',
	'av-dance-shuffle': 'dance', 'av-headbang': 'dance', 'av-boxer-dance': 'dance',
	'av-rap-dance': 'dance', 'av-banging-tunes': 'dance', 'av-conductor': 'dance',
	// Gestures & expression
	wave: 'gesture', 'av-call-me': 'gesture', 'av-brag-claps': 'gesture', pray: 'gesture',
	kiss: 'gesture', taunt: 'gesture', 'av-vtubing': 'gesture', 'av-spy': 'gesture',
	'av-joy': 'gesture', facepalm: 'gesture', angry: 'gesture', lookdown: 'gesture',
	covereyes: 'gesture',
	// Celebrations
	celebrate: 'gesture', 'av-celebrating': 'gesture', 'av-cheering': 'gesture',
	// Action & combat
	jump: 'action', 'av-superhero-jump': 'action', 'av-back-flip': 'action',
	'av-gymnastics-aerial': 'action', 'av-muay-thai': 'action', 'av-chest-bump': 'action',
	'av-arm-flex': 'action', 'av-flexing-arm': 'action', 'av-push-block': 'action',
	'av-stand-crouch-stand': 'action', removing: 'action',
	// Sports
	header: 'sport', goalkeeper: 'sport',
	// Reactions & falls
	reaction: 'reaction', shoved: 'reaction', defeated: 'reaction', dying: 'reaction',
	falling: 'reaction', falltolanding: 'reaction', jumpdown: 'reaction', jumpdown2: 'reaction',
	jumpdown3: 'reaction', sitclap: 'reaction', sitlaugh: 'reaction',
	// Fitness & yoga
	downdog: 'fitness',
});
