/* @ts-self-types="./vanity_grinder.d.ts" */
...
export function grind(prefix, suffix, ignore_case, batch, start_seed) {
    ...
    const ptr2 = passArray8ToWasm0(start_seed, wasm.__wbindgen_export);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.grind(ptr0, len0, ptr1, len1, ignore_case, batch, ptr2, len2);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('vanity_grinder_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
