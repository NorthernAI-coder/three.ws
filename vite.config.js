	...
	build: {
		...
		rollupOptions: {
			...
			input: {
				...
				'arena-omniology': resolve(__dirname, 'pages/arena/omniology.html'),
		...
		},
		{
			...
			configureServer(server) {
				...
				const fileMap = {
					...
					'/alpha-copilot/': resolve(root, 'pages/alpha-copilot.html'),
					'/arena/omniology': resolve(root, 'pages/arena/omniology.html'),
					'/arena/omniology/': resolve(root, 'pages/arena/omniology.html'),
					'/world/atelier': resolve(root, 'pages/world/atelier.html'),
					'/world/atelier/': resolve(root, 'pages/world/atelier.html'),
