...
// The fleet every world spawns with. Parked in a row near the spawn point, facing
// into the plaza, clear of the totem (0,0,-12), the jumbotron (0,0,-30) and the
// Agent Exchange (8,0,-6). yaw is the resting heading (radians, 0 = +z).
export const VEHICLE_SPAWNS = [
	{ id: 'v-coupe-1', type: 'coupe', x: -10, z: 9, yaw: Math.PI },
	{ id: 'v-sedan-1', type: 'sedan', x: -4, z: 9.5, yaw: Math.PI },
	{ id: 'v-pickup-1', type: 'pickup', x: 3, z: 9.5, yaw: Math.PI },
	{ id: 'v-buggy-1', type: 'buggy', x: 9, z: 9, yaw: Math.PI },
	{ id: 'v-coupe-2', type: 'coupe', x: 14, z: 4, yaw: Math.PI * 0.5 },
	{ id: 'v-sedan-2', type: 'sedan', x: -15, z: 3, yaw: -Math.PI * 0.5 },
];
