# Fix failing tests — `tests/mcp-forge-free.test.js`

> 1 of 7 tests in this file are failing. Make it green without weakening coverage.

## Reproduce
```bash
npx vitest run tests/mcp-forge-free.test.js
```

## Failing tests (1)

### forge_free — handler › surfaces a busy lane as a rate_limited error with retry hint
```
AssertionError: expected 'provider_error' to be 'rate_limited' // Object.is equality
    at /workspaces/three.ws/tests/mcp-forge-free.test.js:165:21
```
...
## Done when
- [ ] `npx vitest run tests/mcp-forge-free.test.js` is fully green.
