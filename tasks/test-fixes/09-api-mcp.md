# Fix failing tests — `tests/api/mcp.test.js`

> 1 of 22 tests in this file are failing. Make it green without weakening coverage.

## Reproduce
```bash
npx vitest run tests/api/mcp.test.js
```

## Failing tests (1)

### Protocol layer › malformed JSON body returns HTTP 400
```
...
If you need to partially mock a module, you can use "importOriginal" helper inside:
    ...
    at invoke (/workspaces/three.ws/tests/api/mcp.test.js:286:2)
    at /workspaces/three.ws/tests/api/mcp.test.js:405:22
```
...
## Done when
- [ ] `npx vitest run tests/api/mcp.test.js` is fully green.
