# Fix failing tests — `tests/embodiment-rig-mode.test.js`

> This test file fails to load/run at all. Make it green without weakening coverage.

## Reproduce
```bash
npx vitest run tests/embodiment-rig-mode.test.js
```
...
```
Cannot find module '../src/embodiment/rig-mode.js' imported from /workspaces/three.ws/tests/embodiment-rig-mode.test.js
```
## What to do
...
## Done when
- [ ] `npx vitest run tests/embodiment-rig-mode.test.js` is fully green.
