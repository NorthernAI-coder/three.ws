# Fix failing tests — `tests/api/widgets.test.js`

> 1 of 42 tests in this file are failing. Make it green without weakening coverage.

## Reproduce
```bash
npx vitest run tests/api/widgets.test.js
```

## Failing tests (1)

### POST /api/widgets (create) › rejects body with unknown widget type (400)
```
...
If you need to partially mock a module, you can use "importOriginal" helper inside:
    ...
    at /workspaces/three.ws/tests/api/widgets.test.js:267:3
```
...
## Done when
- [ ] `npx vitest run tests/api/widgets.test.js` is fully green.
