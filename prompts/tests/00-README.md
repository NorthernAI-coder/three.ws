...
- Resilience: prefer the vetted **cockatiel** helper for retries/circuit-breakers
  (see the existing usage in `api/_lib/`). Adopt OSS over hand-rolling; add hardening
  to new/unprotected paths rather than refactoring working code.
