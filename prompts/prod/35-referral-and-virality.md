...
**Phase:** 4 — Growth
**Owns:** sharing surfaces, OG image generation, embeds, referral mechanics, public/embeddable artifacts.
...
3. **Dynamic OG image service:** a real endpoint that renders share images for agents/
   models/launches on the fly (cached, fast, resilient — prompt `06`). No generic
   placeholder image.
