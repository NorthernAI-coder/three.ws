...
- **x402 pay surfaces** — [public/pay/index.html](../../public/pay/index.html) (`/pay`),
  ...
  the buyer-side checkout endpoint [api/x402-checkout.js](../../api/x402-checkout.js)
  (the `/pay` modal POSTs `/x402-checkout?action=prepare|encode`),
  [public/x402-pay-core.js](../../public/x402-pay-core.js), [public/x402.js](../../public/x402.js).
...
2. **Walk the buyer flow in a browser** (`npm run dev`): `/pricing`, then a real
   per-call purchase via the `/pay` modal (`x402-checkout`). Confirm the quote is
