...
3. **Third-party directory submissions.** For each of Smithery, Glama, mcp.so, PulseMCP, LobeHub, produce a ready-to-submit listing in `prompts/store-submissions/_generated/mcp-directories/<directory>.md`:
