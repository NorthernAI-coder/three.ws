...
- `npm test` green; add tests for the metadata shape (model under `animation_url`), royalty cap, and mint idempotency. Evidence to `prompts/store-submissions/_generated/tokenized/`.
