...
- Coin policy grep clean. `npm test` green; add tests for gate pass/fail by balance and access-token expiry. Evidence to `prompts/store-submissions/_generated/gated/`.
