...
## Objective
Produce `prompts/store-submissions/_generated/openai-submission.md` — a copy-paste-ready submission sheet — and a documented **compliance audit** proving the app passes each policy.
