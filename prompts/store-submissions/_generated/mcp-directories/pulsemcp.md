...
# PulseMCP — three.ws MCP submission package
...
## How to submit (fetched 2026-07 from pulsemcp.com/submit)
...
**[HUMAN: no account needed. Optional — submit https://github.com/nirholas/three.ws at pulsemcp.com/submit to speed indexing, or email hello@pulsemcp.com for listing edits.]**

Because PulseMCP is registry-driven, the highest-leverage action is keeping the official registry current (see the republish commands in `../mcp-registry-republish.sh`). Every `io.github.nirholas/*` server flows through automatically.
