...
- **Payments** — settlement runs through the x402 + agent-wallet plumbing in
  ...
  [tests/marketplace-platform-fee.test.js](../../tests/marketplace-platform-fee.test.js).
- **Tests** — [tests/marketplace-agent-detail-prices.test.js](../../tests/marketplace-agent-detail-prices.test.js),
  [tests/marketplace-agent-detail-subscriptions.test.js](../../tests/marketplace-agent-detail-subscriptions.test.js),
  [tests/marketplace-animations.test.js](../../tests/marketplace-animations.test.js),
  [tests/marketplace-platform-fee.test.js](../../tests/marketplace-platform-fee.test.js).
...
9. **Run the tests and ship the changelog:** `npx vitest run tests/marketplace-*.test.js`.
...
- [ ] `npx vitest run tests/marketplace-*.test.js` passes.
