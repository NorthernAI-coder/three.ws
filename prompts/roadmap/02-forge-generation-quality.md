...
> Paste into a fresh Claude Code chat. Follow CLAUDE.md + `prompts/roadmap/00-README.md`. Run `npm run gate` before and after. Prereq: 01 recommended.
...
## Verification
- Run a fixed 10-prompt benchmark before/after; save GLB URLs + the quality signal to `prompts/roadmap/_generated/02/benchmark.md`. Demonstrate measurable improvement (quality flag rate down, success rate up, latency same-or-better).
