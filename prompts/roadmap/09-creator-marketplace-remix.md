...
## Verification
- Browse, filter, sort, and live-preview a populated gallery; open a creator profile with a real remix tree; remix an asset end-to-end and see lineage recorded. Screenshots to `prompts/roadmap/_generated/09/`.
