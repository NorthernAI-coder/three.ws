...
## Verification
- Each modality produces a real 3D result in the browser: sketch→model, photo→avatar, 3 photos→object, voice→scene. Evidence to `prompts/roadmap/_generated/07/`.
