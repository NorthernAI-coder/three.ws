...
Implement the **Model Metadata Enrichment** autonomous pipeline that calls `/api/mcp (inspect_model)` as part of the x402 autonomous spend loop.
...
Passes every model without tags through inspect_model to extract category, style, and feature tags automatically. Enriches searchability and powers the recommendation engine.
