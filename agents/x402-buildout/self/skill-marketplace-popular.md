# 057: Skill Marketplace: Most-Used Skills
...
## What to Build
Pay to retrieve the 5 most-purchased skills in the last 7 days. Extract { skills: [{id, name, purchases}] }. Store signal_data with top_skill_id and top_skill_purchases. Use to prioritize featured listings.
