# 062: MCP Tool: New Tool Discovery
...
## What to Build
Pay x402 to discover newly registered MCP tools since the last probe. Extract { new_tools: [], total_tools }. Run every 2 hours. New tools are logged for agent feature flagging.
