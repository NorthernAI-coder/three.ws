...
## What to Build
Pay to identify whale wallets active on pump.fun right now. Extract { wallets, total_sol_moved }. Store in oracle_intel_signals as a whale_activity signal. Sniper uses this to avoid front-running and to confirm genuine interest.
