# 058: Skill Execution: Canary Run
...
## What to Build
Pay x402 to execute a canary skill (echo_test) and verify it returns within 2 seconds. Extract { executed: bool, latency_ms, output }. If latency > 2000ms, signal a skill execution performance issue.
