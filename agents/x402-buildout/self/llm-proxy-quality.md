# 077: LLM Proxy: Output Quality Probe
...
## What to Build
Pay x402 to verify the LLM proxy returns a correct, deterministic response. Extract { output, correct: bool }. If output !== "15", mark as quality_failure and alert immediately.
