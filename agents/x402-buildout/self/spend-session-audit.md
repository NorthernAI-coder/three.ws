# 064: Spend Session: Active Session Audit
...
## What to Build
Pay x402 to audit currently active spend sessions. Extract { active_count, total_budget_remaining_usdc, expired_count }. Run every 15 minutes. If expired_count spikes, something is preventing session cleanup.
