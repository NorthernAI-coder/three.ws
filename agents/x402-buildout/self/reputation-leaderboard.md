# 071: Reputation: Top Agent Leaderboard
...
## What to Build
Pay x402 to fetch the top 10 agents by reputation score. Extract { agents: [{id, score, rank}] }. Display in platform UI and use to prioritize which agents get promoted in the marketplace.
