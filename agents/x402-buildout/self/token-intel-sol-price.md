# 050: Token Intel: SOL Price Feed
...
- **Method:** POST
- **Body:** `{"mint":"So11111111111111111111111111111111111111112","network":"mainnet"}`

## What to Build
Pay x402 to get SOL native token intelligence: price_usd, 24h change, volume, market_cap. Extract { price_usd, change_24h }. Update oracle_intel_signals with topic=solana_price on every call. Cooldown 300s.
