...
Implement the **VRM 1.0 Compatibility Checker** autonomous pipeline that calls `/api/mcp (inspect_model)` as part of the x402 autonomous spend loop.
...
Validates VRM 0.x avatars can be upgraded to VRM 1.0 spec. Flags incompatible spring bones or expression mappings. Generates a migration report stored per avatar_id.
