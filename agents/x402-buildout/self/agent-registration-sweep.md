# 055: Agent Registration: Active Agent Sweep
...
## What to Build
Pay x402 to fetch reputation scores for the 20 most recently active agents. Extract { count, avg_score, flagged_count }. Flag any agent with score < 30 for review. Store signal_data for platform trust monitoring.
