# 041: Analytics: Sniper Trade Performance
...
## What to Build
Pay to retrieve sniper trade analytics: win rate, avg profit, worst loss, total volume snipped. Extract { win_rate, avg_profit_usdc, total_volume_sol }. Useful for strategy auto-tuning — if win_rate drops below 40%, the loop should log an alert.
