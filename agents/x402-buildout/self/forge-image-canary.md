# 073: Forge: Image Generation Canary
...
## What to Build
Pay x402 for a minimal image generation to verify the image pipeline is alive. Extract { generated: bool, url, latency_ms }. Tests the full AI generation + CDN upload path.
