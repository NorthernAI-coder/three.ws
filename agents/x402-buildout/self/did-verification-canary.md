...
## What to Build
Pay x402 to verify a known canary DID and confirm the resolver returns the correct document. Extract { verified: bool, latency_ms }. Fails if latency > 1500ms or document is malformed.
