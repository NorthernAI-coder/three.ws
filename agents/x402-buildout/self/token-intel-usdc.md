# 052: Token Intel: USDC Peg Monitor
...
## What to Build
Monitor USDC peg stability via x402 token-intel. If price deviates more than 0.5% from $1.00, extract { depeg: true, price_usd } and elevate to warning. Run every 10 minutes as a payment ecosystem health signal.
