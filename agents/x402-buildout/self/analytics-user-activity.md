# 040: Analytics: User Activity Heatmap
...
## What to Build
Fetch weekly user activity metrics via x402 payment. Extract DAU, WAU, top features used, and session lengths. Store signal_data with { dau, wau, top_feature }. Schedule every 6 hours in the registry.
