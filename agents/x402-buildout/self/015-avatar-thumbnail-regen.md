...
Implement the **Avatar Thumbnail Regeneration** autonomous pipeline that calls `/api/x402/asset-download` as part of the x402 autonomous spend loop.

## x402 Endpoint

- **Route:** `/api/x402/asset-download`
- **Price:** `$0.005 USDC/call` per call
- **Category:** 3D Pipeline

## What to Build

Re-renders thumbnail images for avatars whose thumbnails are older than 30 days or whose model was updated. Ensures marketplace listings always show current appearance.
