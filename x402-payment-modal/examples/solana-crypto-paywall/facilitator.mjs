...
//
// This is the standard x402 facilitator wire format (verify/settle), trimmed to
// exactly what the Solana exact path needs so the example stays self-contained
// and easy to read:
//
