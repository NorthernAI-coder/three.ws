...
- **Agent Wallet (MetaMask × x402)** (`/play/agent-wallet`) — Watch your 3D avatar walk up to a paid endpoint and pay for it with the MetaMask agent wallet — a real USDC micropayment signed by the MetaMask Agentic CLI and settled on Base.
