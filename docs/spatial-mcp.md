...
- **Spec:** [`specs/SPATIAL_MCP.md`](../specs/SPATIAL_MCP.md) (v0.1, CC0)
- **Validator (code):** [`api/_lib/spatial-mcp.js`](../api/_lib/spatial-mcp.js) — `validateSpatialArtifact()`, `buildSpatialArtifact()`
...
- [`specs/SPATIAL_MCP.md`](../specs/SPATIAL_MCP.md) — the normative spec
