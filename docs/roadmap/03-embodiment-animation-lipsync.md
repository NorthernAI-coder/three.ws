...
## Verification
- In a browser, load 3 different rigs (e.g. Mixamo, VRM, a simple `shoulderL` rig); each plays new emotes, shows distinct expressions, and lipsyncs to a spoken sentence. Screenshots/clip to `docs/roadmap/_generated/03/`.
