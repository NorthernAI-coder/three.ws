...
## Verification
- Generate 3 distinct scene prompts; each yields a coherent multi-object scene that opens in Scene Studio with selectable named nodes. Screenshots + GLB URLs to `docs/roadmap/_generated/05/`.
