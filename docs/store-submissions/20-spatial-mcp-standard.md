...
- `npm test` green; add validator accept/reject cases and an "all 3D tools emit conformant artifacts" invariant. Evidence to `docs/store-submissions/_generated/spatial-mcp/`.
