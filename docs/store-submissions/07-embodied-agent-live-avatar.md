...
- Generate a persona, send 3 replies of different sentiment — the body lip-syncs and shows 3 distinct, correct expressions. Record a short screen capture / sequence of screenshots to `docs/store-submissions/_generated/embodiment/`.
