...
2. **Write the OpenAPI 3.1 schema.** Create `docs/store-submissions/_generated/openai-actions.yaml`:
...
3. **GPT configuration (write it as a doc the human pastes into the GPT builder):** `docs/store-submissions/_generated/openai-gpt-config.md` with:
